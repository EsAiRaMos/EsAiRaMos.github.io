  ...
  return (
    <div className="contact-container">
      ...
      <div className="contact-content">
        ...
        <img src="https://images.squarespace-cdn.com/content/v1/51fbfed6e4b0a7991b601396/1579553876306-7WWTYGEVQBB2HNHZDF3E/You+can+call+me+on+my+cellphone.gif?format=300w" alt="phone ringing"/>
      </div>
    </div>
  );
}
